...
?>
    ...
    <body>
		<div id="container">
			...
			<![endif]-->
			<nav>
				<div id="logo"><a href="/" style="display:block;">
				<img style="width:237px;height:72px;padding-top:9px;" src="/img/ISR-logo-color-(new)-400px-2016.png" alt="The Institute for Sensory Research" title="The Institute for Sensory Research"/></a>
				</div>
<!-- Start Navigation Menu -->
				...
				<ul id="menu_list" class="inactive">
					...
					<li><a id="Blog" href="https://sensoryguidance.wordpress.com/">BLOG</a></li>
