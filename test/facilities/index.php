...
$('#Facilities').addClass('current');
			...
			<div id="content" class="facilities">
				...
				<div id="facilitiesImages">
					<div class="blue"><!--<a href="#foodbev_link">--><img id="foodbev_img" class="circular" src="img/foodbev.png" alt="Food & Beverage Booths"/><!--</a>-->
						<div class="caption"><B>FOOD & BEVERAGE BOOTHS</B>
							<br/>ASTM STANDARD (23 BOOTHS)</div>
					</div>
					<div class="purple"><!--<a href="#personalcare_link">--><img id="personalcare_img" class="circular" src="img/personalcare.png" alt="Personal Care Booths"/><!--</a>-->
						<div class="caption"><B>PERSONAL CARE BOOTHS</B>
							<br/>ASTM STANDARD (12 BOOTHS)</div>
					</div>
					<div class="red"><!--<a href="#testkitchen_link">--><img id="testkitchen_img" class="circular" src="img/testkitchen.png" alt="Test Kitchen"/><!--</a>-->
				...
				<br clear="all">
					...
					<div class="blue extraindent"><!--<a href="#multipurpose_link">--><img id="multipurpose_img" class="circular" src="img/multipurpose.png" alt="Multi-Purpose Room"/><!--</a>-->
						<div class="caption"><B>MULTI-PURPOSE ROOM</B>
							<br/>(23' x 36')</div>
					</div>
					<div class="purple"><!--<a href="#focusgroup_link">--><img id="focusgroup_img" class="circular" src="img/focusgroup.png" alt="Focus Group Suite"/><!--</a>-->
